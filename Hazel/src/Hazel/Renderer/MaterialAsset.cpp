...
namespace Hazel
{
	...
	const Hazel::Ref<Hazel::MaterialAsset>& MaterialTable::GetMaterialAsset(uint32_t index)
	{
	...
	{
		Ref<Shader> shader = Shader::Create("F:/Kans3D/Hazel/KansEditor/assets/shaders/StaticMeshShader.glsl");
